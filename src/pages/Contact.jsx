...
import { 
  Send, Loader2, Mail, MapPin, MessageSquare, User, MessageCircle, Globe, Sparkles 
} from "lucide-react";
...
const Contact = () => {
  ...
  const socialLinks = [
    { icon: <SiGithub />, href: "https://github.com/alwznx", color: "hover:bg-black-800" },
  ...
  return (
    <section id="contact" className="py-24 bg-slate-950 relative overflow-hidden min-h-screen flex items-center">
      ...
      {/* Background Ambience (Lebih halus) */}
      ...
      <div className="container mx-auto px-6 max-w-7xl">
        ...
        <div className="grid lg:grid-cols-2 gap-10">
          ...
          {/* --- LEFT: CONTACT FORM (PREMIUM GLASS) --- */}
          <motion.div 
          ...
          {/* --- RIGHT: GUESTBOOK (LIVE FEED STYLE) --- */}
          <motion.div 
             initial={{ opacity: 0, x: 50 }}
             whileInView={{ opacity: 1, x: 0 }}
                    ...
                    comments.map((comment) => (
                      <div key={comment.id} className="flex gap-3 animate-in fade-in slide-in-from-bottom-2 duration-500">
                         ...
                         <div className="max-w-[85%]">
                            ...
                            <div className="bg-slate-800/60 p-3 rounded-2xl rounded-tl-none border border-slate-700/50 text-sm text-slate-300 shadow-sm">
                               {comment.message}
                            </div>
                         </div>
                      </div>
